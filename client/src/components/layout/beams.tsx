...
function extendMaterial<T extends THREE.Material = THREE.Material>(
  ...
  if (uniforms.diffuse && defaults.color)
    uniforms.diffuse.value = defaults.color;
  if (uniforms.roughness && "roughness" in defaults)
    uniforms.roughness.value = defaults.roughness;
  if (uniforms.metalness && "metalness" in defaults)
    uniforms.metalness.value = defaults.metalness;
  if (uniforms.envMap && "envMap" in defaults)
    uniforms.envMap.value = defaults.envMap;
  if (uniforms.envMapIntensity && "envMapIntensity" in defaults)
